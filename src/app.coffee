...
if process.platform == 'win32'
  ...
  shortcutPath = app.getPath('appData') + "\\Microsoft\\Windows\\Start Menu\\Programs\\mika.lnk"
...
try
  ...
  app.commandLine.appendSwitch 'ppapi-flash-path', path.join(ROOT, '../external', innerFlashPath)
  app.commandLine.appendSwitch 'ppapi-flash-version', pepperFlashData.version
